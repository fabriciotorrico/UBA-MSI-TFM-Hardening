                  ...
                  <div class="col-sm-6 col-sm-offset-3 myform-cont" >
                         ...
                         <div class="myform-top">
                            <div class="myform-top-left">
                              ...
                              <h3 class="text-black">Alta de Persona</h3>
                      ...
                      <div class="col-md-12" >
                        ...
                        <form  action="{{ url('alta_persona') }}"  method="post" id="f_baja_persona" class="formentrada" >
                          ...
                          <button type="submit" class="mybtn">Dar de Alta</button>
                        </form>
                        </div>
                  </div>
                </div>
