...
<div class="box box-primary">
		...
		<div class="margin" id="botones_control">
				<a href="javascript:void(0);" class="btn btn-xs btn-success" onclick="cargar_formulario(103);">Nuevo cliente</a>
				<a href="{{ url("/listado_clientes") }}"  class="btn btn-xs btn-default" >Actualizar Listado</a>
		</div>

		<div class="box-body table-responsive">
		  <table id="tabla_clientes" class="table table-hover table-striped table-bordered">
			<thead>
				<th>Id cliente</th>
				<th>Cliente</th>
				<th>Descripción</th>
            ...
            { data: null,  render: function ( data, type, row ) {
								//if ($("#rol_usuario").val() === 'admin' || $("#rol_usuario").val() === 'super_admin') {
									if ( row.estado === "Activo") {
										...
										return "<td><button type='button' class='btn btn-success btn-xs' onclick='verinfo_cliente("+data.id_cliente+","+1+")'> <i class='fa fa-pencil-square-o'> Editar Cliente </i></button></td> "
									} else {
