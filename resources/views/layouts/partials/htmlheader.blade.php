<head>
    <meta charset="UTF-8">
    <title> Sistema de Hardening Centralizado - @yield('htmlheader_title', 'Sistema de Hardening Centralizado') </title>
    ...
    <meta name="keywords" content="Sistema de Contabilidad">
    <!-- Bootstrap 3.3.4 -->
