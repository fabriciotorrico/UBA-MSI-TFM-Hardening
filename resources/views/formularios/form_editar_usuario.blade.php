...
@can('gestion_de_roles')
  <div class="box box-primary box-gris">
    <div class="box-header with-border my-box-header">
        <h3 class="box-title"><strong>Gestión de Roles</strong></h3>
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
          ...
          <label class="col-sm-2" for="tipo">Roles asignados </label>
              <div class="col-sm-6" >
                <div id="zona_etiquetas_roles" style="background-color:white;" >
                  @foreach($usuario->getRolesDescription() as $rl)
  ...
  <div class="box box-primary   box-gris" style="margin-bottom: 200px;">
    ...
    <div class="box-body">
        ...
        <form   action="{{ url('editar_acceso') }}"  method="post" id="f_editar_acceso"  class="formentrada"  >
          ...
          <br>
          <div class=" col-xs-12 box-gris" style="text-align: center;">
